...
<div class="video">
    <div class="video1">
        <video controls style="width: 400px; height: 350px;">
            <source src="video/Thor 2011 BRRip 720p Dual Audio [Hin-Eng] by imkhan -=[TDT]=-.mkv" type="video/mp4">
        </video> 
        <div class="video-para">
            <p>Html Tutorial for beginners -1</p>
        </div>
    </div>
    <div class="video2">
         <video controls style="width: 400px; height: 350px;">
         ...
         <div class="video-para">
            <p>Html Tutorial for beginners -2</p>
        </div> 
    </div>
    <div class="video3">
        <video controls style="width: 400px; height: 350px;">
        ...
        <div class="video-para"> 
            <p>Html Tutorial for beginners -3</p>
        </div>
    </div>
</div>
